variables {
    ...
    deb https://dl.astralinux.ru/astra/frozen/1.8_x86-64/1.8.2/main-repository 1.8_x86-64 main contrib non-free
    deb https://dl.astralinux.ru/astra/frozen/1.8_x86-64/1.8.2/extended-repository 1.8_x86-64 main contrib non-free
    EOF
    boot_command = [
...
build {
    ...
    post-processor "vagrant" {
        output = "${source.type}/${replace(source.name, "smolensk", "smolensk-1.8")}.box"
